...
#include <jni.h>
/* Header for class com_tianscar_soundtouch_BPMDetector */

#ifndef _Included_com_tianscar_soundtouch_BPMDetector
#define _Included_com_tianscar_soundtouch_BPMDetector
#ifdef __cplusplus
extern "C" {
#endif
/*
